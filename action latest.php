...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/productlis.css">
...
<body>
  ...
  if(isset($_POST["category"]))
  {
    ...
    echo "
    <div class='panel-group bg-light'>
      <div class='panel panel-default'>
        <div class='panel-heading '>
          <h5 class='panel-title p-3'  style='color: #161C33; height: 40px;'>CATEGORIES
          </h5>
          <a data-toggle='collapse' href='#collapse1' class='text-white'>
          <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
          Floor & Wall Coverings<i class='fas fa-caret-down ml-2'></i>
          </h6>
          </a>
      ...
      while($row = mysqli_fetch_array($run_query))
      {
        ...
        $pcoverage_name = $row["product_coverage"];
          ...
          <a href='#' class='show_selected_category' pcid='$pc_id' style='color: #161C33; font-size: 12px;'>
            <li class='list-group-item' style='border-radius: none; border: none; padding-bottom: 10px;'>$pcoverage_name 
            </li>
            </a>
          ";
      } 
    ...
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Bath & Sanitary Wares<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Plumbing & Fittings<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Building & Construction<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Paints & Sundries<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Doors, Windows, Stairs & Moldings<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Hardware<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Tools & Safety<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Electrical & Appliances<i class='fas fa-caret-down ml-2'></i>
    </h6>
    ...
    <a data-toggle='collapse' href='#collapse3' class='text-white'>
    <h6 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 13px;'>
    Household & Furnitures<i class='fas fa-caret-down ml-2'></i>
    </h6>
...
if(isset($_POST["brand"])){
  ...
  echo "
  <div class='panel-group border border-secondary mt-2'>
    <div class='panel panel-default'>
      <div class='panel-heading'>

        <a data-toggle='collapse' href='#collapse10' class='text-white'>
        <h5 class='panel-title p-3' style='color: #161C33; height: 40px; font-size: 16px;'>
        BRANDS<i class='fas fa-caret-down ml-2'></i>
        </h5>
        </a>
...
if(isset($_POST["get_selected_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"]))
{
  ...
  {    
        ...
        $query = $con->query("SELECT COUNT(*) as rowNum FROM tblproduct WHERE product_keyword LIKE '%$keyword%' ");
      ...
      $sql = "SELECT * FROM tblproduct WHERE product_keyword LIKE '%$keyword%' ORDER BY product_id DESC LIMIT $limit ";
      ...
      while ($row = mysqli_fetch_array($run_query)) 
      {
        ...
        ";
    // back up buttons for modal quick view
    //     <div class='col-md-4'>

    //     <button class='btn qv_btn' qvid='$pro_id' id='quick_view' data-toggle='modal' data-target='#pop1'>
    //         <i class='bi bi-eye-fill'></i>
    //     </button>                                     
    // </div>
    // <div class='col-md-4'>                                            
    //     <button pid='$pro_id' class='btn ac_btn' id='product' data-toggle='tooltip' data-placement='top' title='Add to cart'>
    //         <i class='bi bi-bag'></i>
    //     </button>
    // </div>
    // <div class='col-md-4'>                                       
    //     <button class='btn aw_btn' data-toggle='tooltip' data-placement='top' title='Add to Wishlist'>
    //         <i class='bi bi-suit-heart-fill'></i>
    //     </button>
    // </div>  
    ...
    <div class='row'>
        <div id='img-container' class='col-md-6 d-flex justify-content-center'>
            <img class='img-fluid' src='image/$pro_image'>
        </div>
