...
<body>
    ...
    <div class="row row_back" style="height: 55px;">
            <ol class="breadcrumb col-md-5" style="height: 55px; font-size: 12px;">
                ...
                <li class="breadcrumb-item active" id="all_products_text">Floor & Wall Covering > <u>Ceramic</u> </li>                
            </ol>
        ...
        <div class="row product_container">
            ...
            <div class="col-md-9">
                ...
                $query = $con->query("SELECT * FROM tblproduct WHERE pc_id = 2 ORDER BY product_id DESC LIMIT $limit"); 
